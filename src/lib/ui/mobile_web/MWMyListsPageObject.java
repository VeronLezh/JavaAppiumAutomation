...
public class MWMyListsPageObject extends MyListsPageObject {
    static {
        ...
        SAVED_ARTICLE_LIST_ITEM="xpath://li[@class='page-summary with-watchstar']";
        REMOVE_FROM_SAVED_BUTTON="xpath://li[@class='page-summary with-watchstar' and @title='{TITLE}']//a[contains(@class, 'watched')]";
